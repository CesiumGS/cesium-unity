...
namespace CesiumForUnity
{
    ...
    public static partial class CesiumTransforms
    {
        ...
        /// The longitude (X) and latitude (Y) are in degrees. The height (Z) is in meters above the ellipsoid, and should
        /// not be confused with a geoid, orthometric, or mean sea level height.</param>
