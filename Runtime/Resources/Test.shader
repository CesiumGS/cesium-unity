Shader "Cesium/PointCloudShadingHDRP"
{
    // [ Most of this file is copy-pasted from the HDRP Lit shader. These properties and passes
    //   need to be present for the standard pipeline rendering / SRP batching to work.
    //   Additional comments are put in square brackets to distinguish them from the comments
    ...
    // [ Most of the includes are moved to the subshaders to avoid compilation errors in a URP project. ]
    ...
    SubShader
    {
        ...
        // [ Skip the built-in SceneSelection Pass. The selection outline in the editor uses 
        //   the vertex shader of the first pass declared. ]
        Pass
        {
            ...
            #include "CesiumPointCloudShadingHDRP.hlsl"

            // [ Replace the built-in vertex shader ]
