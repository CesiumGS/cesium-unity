...
namespace NativeScript
{
	...
	public static class Bindings
	{
		...
		public static void Open(int memorySize)
		{
			...
			NativeScript.Bindings.StructStore<Unity.Collections.NativeArray<byte>>.Init(1000);
		...
		private static void OpenPlugin(InitMode initMode)
		{
			...
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(SystemCollectionsGenericIEnumeratorUnityCollectionsNativeArrayPropertyGetCurrentDelegate));
			curMemory += IntPtr.Size;
			...
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(SystemCollectionsGenericIEnumerableUnityCollectionsNativeArrayMethodGetEnumeratorDelegate));
			curMemory += IntPtr.Size;
		...
		static unsafe int SystemCollectionsGenericIEnumeratorUnityCollectionsNativeArrayPropertyGetCurrent(int thisHandle)
		{
			try
			{
				var thiz = (System.Collections.Generic.IEnumerator<Unity.Collections.NativeArray<byte>>)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.Current;
		...
		static unsafe int SystemCollectionsGenericIEnumerableUnityCollectionsNativeArrayMethodGetEnumerator(int thisHandle)
		{
			try
			{
				var thiz = (System.Collections.Generic.IEnumerable<Unity.Collections.NativeArray<byte>>)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.GetEnumerator();
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
